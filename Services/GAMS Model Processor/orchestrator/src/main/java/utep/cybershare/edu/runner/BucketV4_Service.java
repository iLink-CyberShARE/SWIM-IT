...
public class BucketV4_Service {
	...
	public BucketV4_Service(UserScenarioModel userScenario, WMDConfiguration config) {
	...
	private void getGAMSOutput(String varName, String varLabel, String varUnit, String varDescription, String varCategory) {
