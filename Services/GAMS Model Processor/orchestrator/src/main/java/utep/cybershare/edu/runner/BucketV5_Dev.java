...
public class BucketV5_Dev {
	...
	public BucketV5_Dev(UserScenarioModel userScenario) {
	...
	private void initializeGAMS() {
		...
		// GAMSWorkspace("/home/osboxes/Documents/gamsdir/",
		// "/opt/gams/gams24.7_linux_x64_64_sfx/",
		...
		// test case07
		this.t1 = ws.addJobFromFile("src/main/resources/Feb_25_2018_BM_Service.gms");
	 ...
	 * 
	 */
	private void getGAMSOutputParameter(String varName, String varLabel, String varUnit, String varDescription,
			String varCategory) {
