...
public class BucketV5_Service {
	...
	public BucketV5_Service(UserScenarioModel userScenario, WMDConfiguration config) {
	...
	private void handleOutputs() {
		...
		for (int i = 0; i < modelOutputs.size(); i++) {
			...
			if(varType != null) {
				...
				this.getGAMSOutputParameter(varName, varLabel, varUnit, varDescription, varCategory, varinfo);
			}
			else
				this.getGAMSOutput(varName, varLabel, varUnit, varDescription, varCategory, varinfo);
		}
	 ...
	 * 
	 */
	private void getGAMSOutputParameter(String varName, String varLabel, String varUnit, String varDescription, String varCategory, JSONArray varinfo) {
	...
	private void getGAMSOutput(String varName, String varLabel, String varUnit, String varDescription, String varCategory, JSONArray varinfo) {
