...
scalar tStartOffset  /1/; //offset of years after initial   --LG 3/14/18     (1994)
scalar tElements /41/;   //end year --LG 3/14/18 (2033)
...
tfirst(t)    = yes $ (ord(t) eq tStartOffset);        // 1st year     //original 1   //current 10 starts at 2004  //works   result: 1994
...
$gdxin %gdxincname%
$loaddc inflow_multiplier, chooser, sw_sustain_p, gw_sustain_p, Yield_p, Price_p, urb_cost_grow_p, urb_gw_cost_grow_p, urb_back_cost_grow_p, rho_pop_p, p2, w2
$gdxin
...
avgtoturbben, avgenvben, avgrecben, avgtotben, river_flows_p, tot_agpumping, sum_ag_pump_p, source_p, us_mx_1906_p;
