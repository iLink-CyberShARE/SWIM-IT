...
* Updates December 08 2017

* Added a multiplier scalar value for 2-w_supl_new stress taking historical inflows as the base
* Added supply scenario 3-w_supl_HadGEM2-ES  simulation of HadGEM2-ES model @ EB Dam, naturalized values from 1994 - 2015
...
lagtlater(t) = yes $ (ord(t) gt 0);  // lags years after 1
...
/1-w_supl_base,  2-w_supl_new, 3-w_supl_hadgem2-es/
...
$gdxin %gdxincname%
$loaddc inflow_multiplier, chooser, Yield_p Price_p urb_cost_grow_p pop0_p urb_gw_cost_grow_p rho_pop_p p2 w2
$gdxin
...
reduced_urb_back_cost_p        reduced urban backstop technology cost with technical advance
...
* (conveyance channel)    https://waterdata.usgs.gov/nm/nwis/uv?site_no=08358300
                      ...
                      1-w_supl_base  2-w_supl_new  3-w_supl_hadgem2-es
Marcial_h_f.1994          1146           1146               405.50
Marcial_h_f.1995          1400           1400               513.22
Marcial_h_f.1996           446            446               543.84
Marcial_h_f.1997          1146           1146              1049.87
Marcial_h_f.1998           769            769               570.81
Marcial_h_f.1999           866            866               739.12
Marcial_h_f.2000           431            431               640.38
Marcial_h_f.2001           441            441               426.22
Marcial_h_f.2002           241            241               520.57
Marcial_h_f.2003           202            202               480.92
Marcial_h_f.2004           407            407               352.45
Marcial_h_f.2005           969            969               578.36
Marcial_h_f.2006           597            597               514.45
Marcial_h_f.2007           515            515               639.89
Marcial_h_f.2008           933            933               426.60
Marcial_h_f.2009           696            696               548.28
Marcial_h_f.2010           542            542               827.02
Marcial_h_f.2011           308            308              1068.88
Marcial_h_f.2012           288            288               580.52
Marcial_h_f.2013           302            302               679.45
Marcial_h_f.2014           339            339               835.59
Marcial_h_f.2015           402            402               755.07
;

* scalar inflow_multiplier   stress inflow multiplier for 2-w_supl_new  / 0.00/ ;    //LG DEC 8 10:16 am

Source_p(inflow,t,'2-w_supl_new') = inflow_multiplier * source_p(inflow,t,'1-w_supl_base');  // reduce sm inflows to xx% of historical to stress test the model
...
table us_mx_1906_p(t,w)  actual deliveries at Acequia Madre gauge -- data source Rector Dr. Alfredo Granados
        ...
        1-w_supl_base   2-w_supl_new  3-w_supl_hadgem2-es
 1994      60.188        60.188              60.188
 1995      63.641        63.641              63.641
 1996      60.085        60.085              60.085
 1997      59.463        59.463              59.463
 1998      60.650        60.650              60.650
 1999      58.329        58.329              58.329
 2000      60.633        60.633              60.633
 2001      61.059        61.059              61.059
 2002      60.346        60.346              60.346
 2003      26.958        26.958              26.958
 2004      27.623        27.623              27.623
 2005      58.111        58.111              58.111
 2006      27.127        27.127              27.127
 2007      51.263        51.263              51.263
 2008      53.703        53.703              53.703
 2009      57.746        57.746              57.746
 2010      56.404        56.404              56.404
 2011      25.735        25.735              25.735
 2012      23.079        23.079              23.079
 2013       3.766         3.766              3.766
 2014      12.948        12.948              12.948
 2015      33.413        33.413              33.413
;
...
sum_ag_pump_v  (          t,p,w)     sum of ag pumping all nodes                      (L3 \ yr)   (1000 af \ yr)
sum_urb_pump_v (          t,p,w)     sum of urban pumping all nodes                   (L3 \ yr)   (1000 af \ yr)
...
sum_ag_pump_e  (           t,p,w)      Flows: sum of ag pumping all nodes            (L3 \ T)       (1000 af \ yr)
sum_urb_pump_e (           t,p,w)      Flows: sum of urban pumping all nodes         (L3 \ T)       (1000 af \ yr)

*MX_sw_divert_e (           t,p,w)      Flows: total Mexican surface diversion        (L3 \ T)       (1000 af \ yr)
*project_op_e                           Flows: project operation                      (L3 \ T)       (1000 af \ yr)
*project_op2_e                           Flows: project operation                      (L3 \ T)       (1000 af \ yr)
...
urb_av_gw_cost_e(miuse,   t,p,w)       urban ave groundwater pump costs              (L3 \ T)       ($US per ac-ft)
...
urb_av_gw_cost_e(miuse,t,pp,ww).. urb_av_gw_cost_v(miuse,t,pp,ww) =e= urb_av_gw_cost_p(miuse,t);
...
urb_costs_e    (miuse,t,pp,ww)..    urb_costs_v  (miuse,t,pp,ww) =e=        urb_Av_cost_p(miuse,t)  *   urb_sw_use_v(miuse,t,pp,ww)                       // urb total surface water cost
                                            + [urb_Av_cost_p(miuse,t)  + urb_av_gw_cost_v(miuse,t, pp, ww)] *   urb_gw_use_v(miuse,t,pp,ww)                       // urb total pump costs
                                                                     + urb_av_back_cost_p(miuse,t)  * urb_back_use_v(miuse,t,pp,ww);                      // urb total backstop cost
                                                                                                                                                          // total is sum of 3 costs
* need to raise urb pump costs with increased pumping depth
...
* need to raise ag pump costs with increased pumping depth
...
*tacres_v.lo   (aguse,'pecans',k,tlater,p,w) = land_p(aguse,'pecans',k,tlater) - 2;  // protects investments in pecan acreage through non-price methods where needed

* bounds irrigated land to match observed for historical water supply with and without 2008 project agreement operation

tacres_v.lo   ('ebid_u_f',j,k,tlater,p,                '1-w_supl_base') = 0.9999 * land_p('ebid_u_f',j,k,tlater);  // bounds irrigated acreage near historical observed ebid
tacres_v.up   ('ebid_u_f',j,k,tlater,p,                '1-w_supl_base') = 1.0001 * land_p('ebid_u_f',j,k,tlater);  // ebid

tacres_v.lo   ('epid_u_f',j,k,tlater,p,                '1-w_supl_base') = 0.9999 * land_p('epid_u_f',j,k,tlater);  // ditto for epid
tacres_v.up   ('epid_u_f',j,k,tlater,p,                '1-w_supl_base') = 1.0001 * land_p('epid_u_f',j,k,tlater);  // epid

tacres_v.lo   ('mxid_u_f',j,k,tlater,p,                '1-w_supl_base') = 0.9999 * land_p('mxid_u_f',j,k,tlater);  // ditto for mexico
tacres_v.up   ('mxid_u_f',j,k,tlater,p,                '1-w_supl_base') = 1.0001 * land_p('mxid_u_f',j,k,tlater);  // mexico
...
tot_ag_pump_v.up(aqf,aguse,t,p,w)   =   1.0 *   ag_gw_pump_capacity_p(aqf,aguse);   // upper bound on ag pumping by aquifer and farming area
...
X_v.up          (miuse,t,p,w)       =   1.0 * SW_Treat_capac_p(miuse);              // upper bound on all urban river water use from surface treatment:
                                                                                    // none for Las Cruces and Juarez, MX as of 2017.  Model users may wish to change
...
Z_v.lo(res,tlast, p,w)   = 0.25 * sw_sustain_p      *   Z0_p(res,p);     // terminal period surface reservoir storage must reach set percent of max capacity
...
* they're based on a regression estimating caballo releases as a function of inflows and storage

* these 2 equations do not hold when caballo release patterns not set to project operating agreement


X_v.lo('RG_Caballo_out_v_f',                   t, '1-policy_wi_2008_po',   w) $ (ord(t) gt 1)
= min[820,     0  +  0.87547 * source_p('Marcial_h_f',   t,                    w)];          // lower bound matches historical regression

X_v.up('RG_Caballo_out_v_f',                   t, '1-policy_wi_2008_po',   w) $ (ord(t) gt 1)
= min[820,   ( 4  + 0.87547 * source_p('Marcial_h_f',   t,                    w))];          // upper bound close to historical regression

X_v.l('RG_Caballo_out_v_f',                    t,'2-policy_wo_2008_po',  w) $ (ord(t) gt 1)
= min[820,   0.87547  * source_p('Marcial_h_f',  t,                    w)];             // delete upper and lower bounds on Cab release without proj operation

* end of caballo release formula based on historical inflows at SM gauge

* lower bound of 43% of caballo releases to NM-TX stateline

X_v.lo('RG_El_Paso_v_f',    tlater,p,w) = 1.00 * 0.43 * X_v.l('RG_caballo_out_v_f',tlater,p,w);
*X_v.up('RG_El_Paso_v_f',    tlater,p,w) = 1.20 * 0.43 * X_v.l('RG_caballo_out_v_f',tlater,p,w);
...
X_v.lo('MXID_d_f',tlater,p,w) = min[60, 0.12 * X_v.l('RG_Caballo_out_v_f',tlater,p,w)];  // us mx treaty diversions
X_v.up('MXID_d_f',tlater,p,w) =     60;
...
tot_rec_ben_p   (t, p, w)            total recreation benefits          ($1000 \ yr)
...
tot_wat_stocks_p (t,p,w)          =          sum(res, wat_stocks_p(res, t, p, w + eps));
...
tot_wat_flows_p (t, p, w)         =      sum(i, wat_flows_p(i, t, p, w))  + eps;
MX_flows_p    ('MXID_d_f',t,p,w)  =          X_v.l   ('MXID_d_f', t,p,w)  + eps;
Caballo_out_flows_p    ('RG_Caballo_out_v_f',t,p,w)  =          X_v.l   ('RG_Caballo_out_v_f', t,p,w)  + eps;
tot_rg_deliveries_p (t,        p,w) =     sum(river, Caballo_out_flows_p(river, t, p, w))+ eps;
...
total_urb_back_use_p   ( t,p,w)   =   sum(miuse, urb_back_use_p(miuse,    t,p,w)) + eps;
...
tot_inflows(t) = tot_inflows_p(t,p2,w2);
tot_wat_stocks(t) = tot_wat_stocks_p(t, p2, w2);
tot_wat_flows(t) =  tot_wat_flows_p(t, p2, w2);
tot_rg_deliveries(t) = tot_rg_deliveries_p(t, p2, w2);
tot_diversions(t) =  total_diversions_p  (t,p2,w2);
tot_swuse(t) = use_total_p(t,p2,w2);
tot_riverflows(t) = total_river_flows_p(t,p2,w2);
tot_agpumping(t) = sum_ag_pump_p(t,p2,w2);
tot_urbpumping(t)  = sum_urb_pump_p(t,p2,w2);
tot_urbbackuse(t) = total_urb_back_use_p(t,p2,w2);
mx_flows(divert, t) =  MX_flows_p(divert,t,p2,w2);
tot_agbenp(t) = Tot_ag_ben_p(t,p2,w2);
tot_urbbenp(t)= Tot_urb_ben_p(t,p2,w2);
tot_envbenp(t) = Tot_env_riv_ben_p(t,p2,w2);
tot_recben(t) = Tot_rec_res_ben_p(t,p2,w2);

*------------- summary values ---------------*
avgtotben = sum(t, tot_ben(t)) / CARD(t) ;    //Total Economical Benefits (average annual)
avginflows = ((sum(t, tot_inflows(t))) - tot_inflows('1994')) / (CARD(t)-1); //Average Total Inflows
avgstocks = sum(t, tot_wat_stocks(t)) / CARD(t); //Average project storage
avgwaterflows = sum(t, tot_wat_flows(t)) / CARD(t);  //all water flow average
avgwaterdeliveries = ((sum(t, tot_rg_deliveries(t))) - tot_rg_deliveries('1994')) / (CARD(t)-1); //Average Rio Grande Project Surface Deliveries
avgswdivertions = (sum(t, tot_diversions(t))) / (CARD(t)-1);  //Average Basin Surface Water Diversions
avgswuse = sum(t, tot_swuse(t)) / (CARD(t)-1);  //Average total water use   --here
avgriverflows = sum((river,t), river_flows(river,t)) / ((CARD(t)) * (CARD(river))); //Average total river flows - results vary by decimals on river flows
avgagpumping =  ((sum(t, tot_agpumping(t))) - tot_agpumping('1994')) / (CARD(t)-1); //average agricultural
avgurbpumping = ((sum(t, tot_urbpumping(t))) - tot_urbpumping('1994')) / (CARD(t)-1);
avgurbbackuse = sum((miuse,t), urb_back_use(miuse,t)) / (CARD(t) * CARD(miuse));
avgmxflows =  sum((divert,t), mx_flows(divert, t)) / (CARD(t) -1); //Average MX treaty flows pending

*---------- economic summary values ---------*
avgtotagben  = sum(t, tot_agbenp(t)) / (CARD(t) -1);  //Average ag benefits
avgtoturbben = sum(t, tot_urbbenp(t)) / (CARD(t) -1); //Average urban economic benefits
avgenvben = sum(t, tot_envbenp(t)) / (CARD(t) -1);  // Average environmental benefits
avgrecben = sum(t, tot_recben(t)) / CARD(t);  //Average recreation benefits
...
tot_rg_deliveries, avgswdivertions, avgswuse, tot_swuse, avgriverflows, avgagpumping, avgurbpumping, avgurbbackuse, avgmxflows, mx_flows, total_ag_ben, avgtotagben,
avgtoturbben, avgenvben, avgrecben, avgtotben, river_flows, tot_agpumping, sum_ag_pump_p;
