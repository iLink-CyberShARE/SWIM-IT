...
Ag_pump_aq_rch2_e(t,pp,ww)..  Ag_pump_aq_rch_v('hueco_aqf_s'  ,'mxid_u_f',t,pp,ww) =e= sum((j,k), Bag_pump_aqf_return_p('mxid_u_f',j,k) * ag_pump_v('hueco_aqf_s',  'mxid_u_f',j,k,t,pp,ww));  // mx ag pump mesilla aq
Ag_pump_aq_rch3_e(t,pp,ww)..  Ag_pump_aq_rch_v('hueco_aqf_s'  ,'epid_u_f',t,pp,ww) =e= sum((j,k), Bag_pump_aqf_return_p('epid_u_f',j,k) * ag_pump_v('hueco_aqf_s',  'epid_u_f',j,k,t,pp,ww));  // epid ag pump hueco aq
...
aquifer_depth_e(aqf,t,pp,ww)..     Aquifer_depth_v(aqf,t,pp,ww)  =e= [qmax_p(aqf) - Q_v(aqf,t,pp,ww)] / [porosity_p(aqf) * aq_area_p(aqf)];   // simple cube bathub shaped aquifer
...
urb_m_value_e  (miuse,t,pp,ww)..  urb_m_value_v  (miuse,t,pp,ww) =e=    urb_price_v(miuse,t,pp,ww) - (urb_av_cost_p(miuse,t    ) + urb_av_gw_cost_p(miuse,t)); // urb marg value: has errors
...
DNPV_ben_e        (pp,ww)              ..  DNPV_ben_v (pp,ww) =e=  sum(tlater,         tot_ag_ben_v(tlater,pp,ww))
...
execute_unload 'wmd', evaporation;
...
*par = MX_flows_p             rng =  opt_US_MX_deliveries!c4    cdim = 0
