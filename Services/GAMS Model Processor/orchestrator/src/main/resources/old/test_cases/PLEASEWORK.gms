...
us_mx_1906_p     us mexico 1906 treaty flows
tx_proj_op_p   project operation tx proportion of nm tx water sharings
sw_sustain_p   terminal sustainability proportion of starting sw storage
gw_sustain_p   terminal sustainability proportion of starting gw storage;
...
$gdxin %gdxincname%
$loaddc us_mx_1906_p tx_proj_op_p sw_sustain_p pop0_p gw_sustain_p
$gdxin
...
table land_p(use,j,k)     land in production in a base full supply year eg 2005 (EBID + EP1) (1000 acres)
...
parameter rho_pop_p(miuse)     population growth rate per year
...
TABLE source_p(inflow,t)  annual basin inflows at headwaters -- snowpack or rain (1000 af \ year)
