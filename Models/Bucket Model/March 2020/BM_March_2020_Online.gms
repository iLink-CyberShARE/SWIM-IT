...
* Sync with changes from Greg Torell based on environmental flows code
* Only one dataset column for san marcial inflows (will be loaded from SWIM)
...
Nov 11 2019. Keeping only one default water supply scenario, other water supply inflows will be loaded externally from user interface.
             The default is Observed Inflows + Extended drought
...
Increased aquifer protection should limit pumping and reduce total use, andshould certainly reduce gw use.
...
1. 1_Selected_Inflows:  Selected Inflows from the SWIM 2.0 user interface.
...
**************** Section 1B *************************************************************
*  This section loads some of the parameters dynamically, ACTIVATE FOR SWIM
...
* March 2020   Current baseline is observed inflows + extended drought
...
Marcial_h_f.2014        308.92
Marcial_h_f.2015        288.43
Marcial_h_f.2016        303.07
Marcial_h_f.2017        308.92
Marcial_h_f.2018        288.43
Marcial_h_f.2019        303.07
Marcial_h_f.2020        308.92
Marcial_h_f.2021        288.43
Marcial_h_f.2022        303.07
Marcial_h_f.2023        308.92
Marcial_h_f.2024        288.43
Marcial_h_f.2025        303.07
Marcial_h_f.2026        308.92
Marcial_h_f.2027        288.43
Marcial_h_f.2028        303.07
Marcial_h_f.2029        308.92
Marcial_h_f.2030        288.43
Marcial_h_f.2031        303.07
Marcial_h_f.2032        308.92
Marcial_h_f.2033        288.43
;
...
z0_p  ('Store_res_s', p)   = 1.00 * 2204.7;   // historical starting level in 1994
...
Z_v.lo        (res, tlast,p,w) = sw_sustain_p * zmax_p('store_res_s');          // terminal period return for reservoir storage in proportion of maximum capacity
Q_v.lo        (aqf, tlast,p,w) = gw_sustain_p(aqf) * Q0_p(aqf);               // terminal aq can be zero without aquifer protection in proportion of starting stocks
...
precip, tacres, tswacres, tgwacres, ttacres, urb_back_use, urb_back_aq_rch, dnpv_ben, avgtotben, avginflows, avgstocks, avgwaterflows, avgwaterdeliveries,
avgswdivertions, avgswuse, avgriverflows, avgagpumping, avgurbpumping, avgurbbackuse, avgmxflows, mx_flows, avgtotagben,
avgtoturbben, avgenvben, avgrecben, avgtotben, river_flows_p, tot_agpumping, tot_urbpumping, tot_wat_flows, sum_ag_pump_p, source_p, tot_urbbenp,
...
cost_af_flow_import_p, cost_af_flow_export_p, elas_p, urb_av_back_cost0_p, tx_proj_op_p, source_p, precip_rate_p, evap_rat_p;
...
par=rho_p                   rng =  rho_p!B2                   cdim = 0
par=backstop_cost_p         rng =  backstop_cost_p!B2         cdim = 0
par=Yield_p                 rng =  Yield_p!B2                 cdim = 0
par=Price_p                 rng =  Price_p!B2                 cdim = 0
par=lan_p                   rng =  lan_p!B2                   cdim = 0
par=Ba_divert_p             rng =  Ba_divert_p!B2             cdim = 0
par=Ba_use_p                rng =  Ba_use_p!B2                cdim = 0
par=Bar_return_p            rng =  Bar_return_p!B2            cdim = 0
par=Baa_return_p            rng =  Baa_return_p!B2            cdim = 0
par=Bag_pump_aqf_return_p   rng =  Bag_pump_aqf_return_p!B2   cdim = 0
par=Cost_p                  rng =  Cost_p!B2                  cdim = 0
par=ag_av_gw_cost_p         rng =  ag_av_gw_cost_p!B2         cdim = 0
par=ag_av_back_cost0_p      rng =  ag_av_back_cost0_p!B2      cdim = 0
par=cost_af_flow_import_p   rng =  cost_af_flow_import_p!B2   cdim = 0
par=Bag_pump_aqf_return_p   rng =  Bag_pump_aqf_return_p!B2   cdim = 0
par=cost_af_flow_export_p   rng =  cost_af_flow_export_p!B2   cdim = 0
par=elas_p                  rng =  elas_p!B2                  cdim = 0
par=urb_av_back_cost0_p     rng =  urb_av_back_cost0_p!B2     cdim = 0
par=tx_proj_op_p            rng =  tx_proj_op_p!B2            cdim = 0
par=source_p                rng =  source_p!B2                cdim = 0
par=us_mx_1906_p            rng =  us_mx_1906_p!B2            cdim = 0
par=precip_rate_p           rng =  precip_rate_p!B2           cdim = 0
par=evap_rat_p              rng =  evap_rat_p!B2              cdim = 0
