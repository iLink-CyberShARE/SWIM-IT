$EOLCOM //
$TITLE RIO GRANDE BASIN HYDROECONOMIC MODEL
...
Enviromental crop acreage schedules over historical period (1994-2015)

* ---------------------------------------------------------------------------------------------------------------------------------------------------------

*  AUG 29 2019

Added environmental crop that will be forced to cover 1000 acres according to environmental schedule loops
...
scalar tElements /31/;   //end year --LG 11/21/19 (2015)      --40-x
scalar inflow_adjustment_p / 0.75 / ; //increase inflows by this amount
...
tlast(t)     = yes $ (ord(t) eq tElements);  // GAMS language -- picks last pd   //result  :2015
tlater(t)    = yes $ (ord(t) gt tStartOffset and ord(t) lt tElements+1);        // picks years after 1     //original 1 //result: 1994-2015
tpost2008(t) = yes $ (ord(t) gt 13 and ord(t) lt tElements+1);
lagtlater(t) = yes $ (ord(t) gt 0);

alias (tfirst, ttfirst);

*display tfirst, lagtlater, tlast;
...
1. Historical: Historical sum of San Marcial Gauges (1994-2015))
...
* generic parameters
*----------------------------------------------------------------------------------------
parameter rho_p discount rate /0.00/
;
...
2016        31.391                  25.503                  16.493
2017        31.391                  25.503                  16.493
2018        31.391                  25.503                  16.493
2019        31.391                  25.503                  16.493
2020        31.391                  25.503                  16.493
2021        31.391                  25.503                  16.493
2022        31.391                  25.503                  16.493
2023        31.391                  25.503                  16.493
2024        31.391                  25.503                  16.493
...
2014           8.252                  34.303           4.583
2015           8.252                  34.303           4.583
2016           8.252                  34.303           4.583
2017           8.252                  34.303           4.583
2018           8.252                  34.303           4.583
2019           8.252                  34.303           4.583
2020           8.252                  34.303           4.583
2021           8.252                  34.303           4.583
2022           8.252                  34.303           4.583
2023           8.252                  34.303           4.583
2024           8.252                  34.303           4.583
...
2016       0.250                        4.313                 24.269
2017       0.250                        4.313                 24.269
2018       0.250                        4.313                 24.269
2019       0.250                        4.313                 24.269
2020       0.250                        4.313                 24.269
2021       0.250                        4.313                 24.269
2022       0.250                        4.313                 24.269
2023       0.250                        4.313                 24.269
2024       0.250                        4.313                 24.269
...
* Mexico elasticity of water to price is -0.33 - A. Salazar, N. Pineda http://www.scielo.org.mx/scielo.php?pid=S1870-39252010000300001&script=sci_arttext
...
scalar counter /1/;  // main loop c ounter variable over policy(p) and supply(w)
scalar chooser /2/;  // chooses what policy and supply combination to execute on the loop, skips the rest.
...
table     source_p_table(inflow,t,w)  annual basin inflows at headwaters -- snowpack or rain (1000 af \ year)
...
* Jan 2019    NOTE: CURRENTLY WITH HIGH INFLOWS +200 ON HISTORICAL

                     hist_extended
Marcial_h_f.1994        1146.04
Marcial_h_f.1995        1406.09
Marcial_h_f.1996        458.13
Marcial_h_f.1997        1129.53
Marcial_h_f.1998        777.54
Marcial_h_f.1999        863.98
Marcial_h_f.2000        439.23
Marcial_h_f.2001        449.37
Marcial_h_f.2002        251.87
Marcial_h_f.2003        209.08
Marcial_h_f.2004        398.4
Marcial_h_f.2005        957.95
Marcial_h_f.2006        596.48
Marcial_h_f.2007        528.64
Marcial_h_f.2008        924.36
Marcial_h_f.2009        699.5
Marcial_h_f.2010        546.09
Marcial_h_f.2011        313.7
Marcial_h_f.2012        299.29
Marcial_h_f.2013        282.28
Marcial_h_f.2014        324.92
Marcial_h_f.2015        542.11
Marcial_h_f.2016        813.68
Marcial_h_f.2017        1019.61
Marcial_h_f.2018        692.80
Marcial_h_f.2019        1031.82
Marcial_h_f.2020        587.43
Marcial_h_f.2021        869.29
Marcial_h_f.2022        2020.33
Marcial_h_f.2023        1140.26
Marcial_h_f.2024        1503.74
;

parameter source_p(inflow,t,w)  annual basin inflows at headwaters -- snowpack or rain (1000 af \ year) ;
          source_p(inflow,t,w) = source_p_table(inflow,t,w) * inflow_adjustment_p;
...
parameter env_mul(t, n)  environmental flows multiplier

*Load schedule data from GDX file
$gdxin schedules.gdx
$loaddc env_mul
$gdxin
...
Xv_lb_p(t)  lower bound on stream gauge flows compared to historical
...
* --------------------------------------------------------------------------------------
* Environmental Water Diversions
* --------------------------------------------------------------------------------------
* EN_sw_divert_e(t,pp,ww)..   EN_sw_divert_v(t,pp,ww) =e= X_v('ENFL_d_f', t, pp, ww);
...
*pulse flows can only come from surface water
ag_pump_v.up(aqf, aguse,'environmental_crop',k,t,pp,ww) = 0 ;
...
parameter mod_stat_p  (p,w,n)                    model optimality status;
parameter dn(p,w,n)                              global benefits;
parameter urban_dn(p,w,n)                        urban benefits;
parameter ag_dn(p,w,n)                           ag benefits;
parameter env_dn(p,w,n)                          environmental benefits;
parameter rec_dn(p,w,n)                          recreational benefits;
parameter imp_dn_cost(p,w,n)                     import costs;
parameter exp_dn_cost(p,w,n)                     export costs;
parameter ben_districts_ag(aguse,p,w, n)         benefits by district;
parameter ben_cities_urb(miuse,p,w,n)            benefits by city;
parameter ben_enviroment_riv(river,p,w,n)        environmental benefits;
parameter ben_recreational_res(res,p,w,n)        recreational benefits;
parameter diversions(divert,t,p,w,n)             surface water diversions per sector;
parameter fland(aguse, j, k, t, p, w, n)         land acreage in producion per district and crop;
parameter district_use(aguse,t,p,w,n)            water use per district;
parameter ag_pumping(aqf,aguse,t,p,w,n)          water pumping per ag district and aquifer source;
parameter aquifer_return(aga_return,t,p,w,n)     return flows from river to aquifer;
parameter env_mult(t)                            environmental flows multiplier;
scalar globmax /0/;
parameter bestsol /0/;
parameter wat_stocks_p_n(res,t,p,w,n)              ;
parameter Aquifer_depth_p_n(aqf,t,p,w,n)           ;
parameter gw_stocks_p_n(aqf,t,p,w,n)               ;
parameter all_flows(i,t,p,w,n);

//shadow prices
parameter shad_price_env_crop(aguse,j,k,t,p,w,n)   shadow price for environmental crop;


ww(w) = no;
pp(p) = no;

loop (p, // policy loop  x2
    loop (w, // supply loop x1
         loop(n, //schedule loop x6
               ww(w)   = yes;
               pp(p)   = yes;

               If ((counter eq chooser or chooser eq -1),
                        env_mult(t) = env_mul(t, n);
                        ...
                        // tacres_v.up('ebid_u_f', 'environmental_crop', k, t, p, w) = 5 * env_mult(t);
                        // tacres_v.up('epid_u_f', 'environmental_crop', k, t, p, w) = eps;
                        // tacres_v.up('mxid_u_f', 'environmental_crop', k, t, p, w) = eps;

                        // solve model
                        solve RIO_PROTOTYPE using nlp maximizing DNPV_v;

                        // global benefits
                        dn(p,w,n)                          = DNPV_ben_v.l(p,w) + eps;                    // total regional benefits over all sectors
                        urban_dn(p,w,n)                    = DNPV_urb_ben_v.l(p,w) + eps;                // urban benefits
                        ag_dn(p,w,n)                       = DNPV_ag_ben_v.l(p,w)+ eps;                  // agricultural benefits
                        env_dn(p,w,n)                      = DNPV_env_riv_ben_v.l(p,w) + eps;            // environmental benefits
                        rec_dn(p,w,n)                      = DNPV_rec_res_ben_v.l(p,w) + eps;            // recreation benefits
                        imp_dn_cost(p,w,n)                 = DNPV_import_costs_v.l(p,w)+ eps;            // import costs
                        exp_dn_cost(p,w,n)                 = DNPV_export_costs_v.l(p,w)+ eps;            // export costs
                        // benefits by node
                        ben_districts_ag(aguse,p,w,n)      = sum((t), Ag_Ben_v.l(aguse,t,p,w))  + eps;   // benefits by district
                        ben_cities_urb(miuse,p,w,n)        = sum((t), urb_value_v.l(miuse,t,p,w)) + eps; // benefits by urban area
                        ben_enviroment_riv(river,p,w,n)    = sum((t), Env_ben_v.l(river,t,p,w)) + eps;   // benefits by river location
                        ben_recreational_res(res,p,w,n)    = sum((t), rec_ben_v.l(res,t,p,w)) + eps;     // benefits by water stored in the reservoir
                        // other outputs
                        diversions(divert,t,p,w,n)         = X_v.l(divert,t,p,w)  + eps;                 // water diversions
                        fland(aguse, j, k, t, p, w, n)     = tacres_v.l(aguse, j, k, t, p, w) + eps;           // crop acreage
                        district_use(aguse,t,p,w,n)        = ag_use_v.l(aguse,t,p,w)  + eps;             // use by district
                        ag_pumping(aqf,aguse,t,p,w,n)      = tot_ag_pump_v.l(aqf,aguse,t,p,w) + eps;     // pumping by district and aquifer source
                        aquifer_return(aga_return,t,p,w,n) = aga_returns_v.l(aga_return,t,p,w) + eps;    // returns from river to aquifer by irrigation district
                        //shadow prices

                        shad_price_env_crop(aguse,'environmental_crop',k,t,p,w,n)   =   tacres_v.m(aguse, 'environmental_crop', k, t, p, w) + eps;
                        all_flows(i,t,p,w,n)                =   X_v.l(i,t,p,w)  +eps  ;
                        wat_stocks_p_n(res,t,p,w,n)   =          Z_v.l    (res,      t,p,w)  + eps;
                        Aquifer_depth_p_n(aqf,t,p,w,n)   =  Aquifer_depth_v.l(aqf,       t,p,w)  + eps;
                        gw_stocks_p_n(aqf,t,p,w,n)   =          Q_v.l    (aqf,       t,p,w)  + eps;
                        // best dnpv from all runs
                        if (dn(p,w,n) > globmax,
                              globmax = dn(p,w,n);
                              bestsol = DNPV_ben_v.l(p,w);
                        );
               );

               mod_stat_p (p,w,n)  = RIO_PROTOTYPE.Modelstat + eps;
...
envflows_p      (          t,p,w)    environmental river flows          (1000 af \ yr)
...
execute_unload "env_results-12-18_no_disc_25_pcnt.gdx"

dn, urban_dn, ag_dn, env_dn, rec_dn, imp_dn_cost, exp_dn_cost, bestsol, fland, ben_districts_ag, ben_cities_urb,
ben_enviroment_riv, ben_recreational_res, district_use, diversions, ag_pumping, aquifer_return, shad_price_env_crop, wat_stocks_p_n, Aquifer_depth_p_n , gw_stocks_p_n , all_flows;

$onecho > gdxxrwout_no_disc_25_pcnt.txt

i=env_results-12-18_no_disc_25_pcnt.gdx
o=env_results-12-18_no_disc_25_pcnt.xlsx
...
par = dn                         rng = dnpv!a2                  cdim = 0
par = ag_dn                      rng = ag_dn!a2                 cdim = 0
par = urban_dn                   rng = urban_dn!a2              cdim = 0
par = env_dn                     rng = env_dn!a2                cdim = 0
par = rec_dn                     rng = rec_dn!a2                cdim = 0
par = imp_dn_cost                rng = imp_dn_cost!a2           cdim = 0
par = exp_dn_cost                rng = exp_dn_cost!a2           cdim = 0
par = ben_districts_ag           rng = ben_districts!a2         cdim = 0
par = ben_cities_urb             rng = ben_cities_urb!a2        cdim = 0
par = ben_enviroment_riv         rng = ben_enviroment_riv!a2    cdim = 0
par = ben_recreational_res       rng = ben_recreational_res!a2  cdim = 0
par = bestsol                    rng = bestsol!a2               cdim = 0
par = fland                      rng = acreage_crop!a2          cdim = 3
par = district_use               rng = dist_use!a2              cdim = 0
par = diversions                 rng = diversions!a2            cdim = 0
par = ag_pumping                 rng = ag_pumping!a2            cdim = 0
par = aquifer_return             rng = river_aquifer_return!a2  cdim = 0
par = shad_price_env_crop        rng = shad_price_env_crop!a2   cdim = 0
par = wat_stocks_p_n             rng = reservoir_stocks!a2      cdim = 0
par = Aquifer_depth_p_n          rng = aquifer_depth!a2         cdim = 0
par = gw_stocks_p_n              rng = aquifer_stocks!a2        cdim = 0
*----------------------* end of model optimized results *----------------*

$offecho
execute 'gdxxrw.exe @gdxxrwout_no_disc_25_pcnt.txt trace=2';
