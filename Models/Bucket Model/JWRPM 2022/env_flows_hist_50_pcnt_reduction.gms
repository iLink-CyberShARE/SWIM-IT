...
scalar inflow_adjustment_p / 0.5 / ; //increase inflows by this amount
...
execute_unload "env_results-12-18_50_pcnt.gdx"
...
$onecho > gdxxrwout_50_pcnt.txt

i=env_results-12-18_50_pcnt.gdx
o=env_results-12-18_50_pcnt.xlsx
...
$offecho
execute 'gdxxrw.exe @gdxxrwout_50_pcnt.txt trace=2';
