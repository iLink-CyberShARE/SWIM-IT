...
* Alex Mayer
  ...
  Last Update: October 6, 2018 - LG  (Data Updates)
...
/1-w_supl_base,  2-w_supl_new, 3-w_supl_obs_drought, 4-w_supl_hadgem2, 5-w_supl_hadgem2_drought, 6-w_supl_hadgem2_rcp85_r1i1p1/ ;
...
nj(j)  non commercial crop

/    forage_alt/

nf(j)  non forage crop
...
$gdxin %gdxincname%
$loaddc inflow_multiplier, lb_ecrop, chooser, sw_sustain_p, gw_sustain_p, Yield_p, Price_p, urb_cost_grow_p, urb_gw_cost_grow_p,urb_av_back_cost0_p, urb_back_cost_grow_p, rho_pop_p, p2, w2, tStartOffset, tElements
$gdxin
...
*                  Pecans.flood     Veges.flood  forage.flood    forage_alt.flood
*-------------------------- use node rows (+) ---------------
...
*$ontext
*                   Pecans                        Veges                    forage                       forage_alt
*EBID_u_f            4960                          250                       120                            110
*EPID_u_f            4960                          250                       120                            110
*MXID_u_f            4960                          250                       120                            110
*;

*price_p(aguse,'forage_alt','2-policy_wo_2008_po') = 110;
...
lan_p(t,'forage_alt',k,aguse) = 0.001;  // essentially zero observed land in alternative forage
...
land_p(aguse,j,k,tfuture) = land_p(aguse,j,k,'2015');  // moves forward to 2033

display land_p;

*scalar lb_ecrop  /4/; //minimum environmental crop acres
...
*$ontext
                      Pecans.flood   Veges.flood     forage.flood        forage_alt.flood
*-------------------------- use node rows (+) ------------------------
EBID_u_f               1700            3600            820                   820
EPID_u_f               1710            3620            825                   825
MXID_u_f               1715            3640            828                   828
*---------------------------------------------------------------------
...
;
cost_af_unit_depth_p = 0.235
;

* calculations from Shane Walker UTEP Civil Engineering: Jan 9 2018
...
*C = c dp = .235 per acre foot

display cost_af_unit_depth_p;

scalar prop_base_back_cost_p   proportion of backstop technology cost for new scenario   / 1.00/

parameter ag_av_back_cost_p(aguse,j,k)  average ag backstop technology water supply cost
;

ag_av_back_cost_p(aguse,j,k) = 1444;

*Backstop technology cost: Potential of membrane distillation in seawater desalination: Thermal efficiency, sensitivity study and cost estimation
*l-Obaidani, S (Al-Obaidani, Sulaiman)
...
parameter
B0_p(aguse,cj,k,t)     intercept term in crop-water prodn fn forces vmp of water = water price     (tons per acre)
B1_p(aguse,cj,k,t)     linear term does the same (<0) Greater land in production reduces ave yield (tons per 1000 acres)
;

B1_p(aguse,cj,k,tlater)   =  -Netrev_acre_p(aguse,cj,k) / [Price_p(aguse,cj) * Land_p(aguse,cj,k,tlater)]; // For profit max, higher obs net rev per ac brings more acreage to reduce yields
B0_p(aguse,cj,k,tlater)   =   Yield_p(aguse,cj,k) - B1_p(aguse,cj,k,tlater)  * Land_p(aguse,cj,k,tlater);
...
;                         //  Source:  demouche landfair ward nmwrri tech completion report 256 2010 page 11 demands for year 2009 las cruces water utility
                          ...
                          //  Water Resources Development, Vol. 27, No. 2, 291\96314, June 2011
...
* Authors:  Diego T\E9llez, Horacio Lom, Pablo Chargoy, Lu\EDs Rosas, Mar\EDa Mendoza, Monserrat Coatl, Nuria Mac\EDas, Ren\E9 Reyes
...
* (conveyance channel)    https://waterdata.usgs.gov/nm/nwis/uv?site_no=08358300
                    ...
                    1-w_supl_base  3-w_supl_obs_drought    4-w_supl_hadgem2        5-w_supl_hadgem2_drought     6-w_supl_hadgem2_rcp85_r1i1p1
Marcial_h_f.1994        1146            1146.214                423.649                   423.649                         394.31
Marcial_h_f.1995        1400            1400.112                536.187                   536.187                         573.10
Marcial_h_f.1996        446              445.999                568.176                   568.176                         604.54
Marcial_h_f.1997        1146            1144.599               1096.854                  1096.854                        1099.42
Marcial_h_f.1998        769              769.403                596.358                   596.358                         569.36
Marcial_h_f.1999        866              866.133                772.199                   772.199                         764.24
Marcial_h_f.2000        431              431.808                669.35                    669.35                          659.64
Marcial_h_f.2001        441              441.343                445.299                   445.299                         417.29
Marcial_h_f.2002        241               240.88                543.871                   543.871                         539.78
Marcial_h_f.2003        202              201.904                502.442                   502.442                         485.98
Marcial_h_f.2004        407              407.308                368.224                   368.224                         362.43
Marcial_h_f.2005        969              969.196                604.246                   604.246                         585.52
Marcial_h_f.2006        597               597.73                537.476                   537.476                         536.53
Marcial_h_f.2007        515               515.14                668.529                   668.529                         664.19
Marcial_h_f.2008        933              933.802                445.697                   445.697                         421.77
Marcial_h_f.2009        696              696.047                572.821                   572.821                         600.95
Marcial_h_f.2010        542              542.777                864.032                   864.032                         891.20
Marcial_h_f.2011        308              307.935                1116.721                 1116.721                        1093.94
Marcial_h_f.2012        288              287.718                606.497                   606.497                         570.41
Marcial_h_f.2013        302              302.441                709.86                    709.86                          752.97
Marcial_h_f.2014        339              307.935                872.982                   307.935                         878.88
Marcial_h_f.2015        402              287.718                788.867                   287.718                         791.26
Marcial_h_f.2016          0              302.441                710.581                   302.441                         692.45
Marcial_h_f.2017          0              307.935                1305.051                  307.935                        1299.33
Marcial_h_f.2018          0              287.718                698.509                   287.718                         667.52
Marcial_h_f.2019          0              302.441                552.366                   302.441                         535.03
Marcial_h_f.2020          0              307.935                362.82                    307.935                         381.68
Marcial_h_f.2021          0              287.718                1170.886                  287.718                        1145.18
Marcial_h_f.2022          0              302.441                821.108                   302.441                         790.77
Marcial_h_f.2023          0              307.935                997.165                   307.935                        1075.79
Marcial_h_f.2024          0              287.718                973.922                   287.718                         964.32
Marcial_h_f.2025          0              302.441                816.331                   302.441                         834.12
Marcial_h_f.2026          0              307.935                1097.737                  307.935                        1080.26
Marcial_h_f.2027          0              287.718                963.01                    287.718                         978.78
Marcial_h_f.2028          0              302.441                508.851                   302.441                         515.11
Marcial_h_f.2029          0              307.935                669.577                   307.935                         670.47
Marcial_h_f.2030          0              287.718                792.178                   287.718                         761.56
Marcial_h_f.2031          0              302.441                417.024                   302.441                         374.95
Marcial_h_f.2032          0              307.935                351.756                   307.935                         353.05
Marcial_h_f.2033          0              287.718                562.75                    287.718                         589.22
;
...
us_mx_1906_p(t,'6-w_supl_hadgem2_rcp85_r1i1p1') =  us_mx_1906_p(t,'1-w_supl_base');
...
* Variales for op 2008
D1_v (t, p, w) d1 relation
D2_v (t, p, w) d2 relation
;
...
Yield1_e       (aguse,j,k, t,p,w)      crop yield non commercial crops
...
* 2008 operating agreement eqs

proj_operate_2008_e(t,p,w)             operating agreement
D1_e               (t,p,w)             D1 relation (deliveries)
D2_e               (t,p,w)             D2 relation (diversions)
US_MX_1906_e       (t,p,w)             US MX treaty flows
nm_tx_e            (t,p,w)             NM to TX agreement flows
...
Yield_e     (aguse,cj,k,t,pp,ww)  $ (ord(t) ge 1)..       Yield_v(aguse,cj,k,t,pp,ww)   =e=    B0_p(aguse,cj,k,t)  + B1_p(aguse,cj,k,t) * Tacres_v(aguse,cj,k,t,pp,ww);  // postive math programming calibration if needed
Yield1_e    (aguse,nj,k,t,pp,ww)  $ (ord(t) gt 1)..       Yield_v(aguse,nj,k,t,pp,ww)   =e= yield_p(aguse,nj,k);
...
Ag_m_value_e(aguse,cj,k,t,pp,ww)..    Ag_m_value_v(aguse,cj,k,t,pp,ww)   =e=  [price_p(aguse,cj) *   Yield_v(aguse,cj,k,t,pp,ww)      - Cost_p(aguse,cj,k)] * (1/Ba_use_p(aguse,cj,k)) +
                                                                               price_p(aguse,cj) * SWacres_v(aguse,cj,k,t,pp,ww) *       B1_p(aguse,cj,k,t)  * (1/Ba_use_p(aguse,cj,k));
* --------------------------------------------------------------------------------------
...
***********************************************************************************************************************
* Code below handles the 2008 Project Operating Agreement in several related steps
***********************************************************************************************************************

* Caballo outflow below is a function of (1) San Marcial inflows and (2) Rio Grande Project surface storage
* Statistical regression predicting historical gauged outflow from Caballo as a function of the two above
* approximates actual project operation - 1997 - 2015.

* Code below states that annual outflows at the Caballo gauge in each year equal the minimum of 875,000 acre feet and  * sum of two terms.  Terms are 0.567 * San Marcial annual inflows in the same year + 0.45873 * Project Surface * *
* Reservoir Storage in same year

proj_operate_2008_e(tlater,pp,ww)..  X_v('RG_Caballo_out_v_f',tlater, pp,ww)

                              =e=   min
                                       {875,      [0.56708 * source_p('marcial_h_f',tlater,    ww)]
                                                 + 0.46873 * (Z_v    ('store_res_s',tlater, pp,ww))
                                       };

* Code below reflects the D1 and D2 relationships, both important for implementing the 2008 operating agreement (OA):

* The D1 relationship below states that annual PROJECT DELIVERIES under the OA are 0.826 times Caballo total annual
* releases minus 124,000 acre feet.

D1_e(tlater,pp,ww)..

D1_v(tlater,pp,ww)  =e= [X_v('RG_caballo_out_v_f',tlater,'1-policy_wi_2008_po', ww) - 124.0] * 0.826;

* The D2 relationship below states that annual PROJECT DIVERTABLE FLOWS TO PROJECT USERS under the OA = 1.34
* times total Caballo annual releases minus 69,000 acre feet

D2_e(tlater,pp,ww)..

D2_v(tlater,pp,ww)  =e= [X_v('RG_Caballo_out_v_f',tlater,'1-policy_wi_2008_po', ww) -  69.0] * 1.34;


* The US Mexico delivery relationship below states that annual surface water diversions by Mexico from the river,
* implemented in part by the OA are the minimum of 60,000 acre feet and 0.113 times the D1 (project deliveries) above.

US_MX_1906_e(tlater,pp,ww)..     MX_sw_divert_v(tlater,'1-policy_wi_2008_po',ww)
                                     =e= min{60,   0.113 * D1_v(tlater,'1-policy_wi_2008_po',ww)
                                            };

* Code below summarizes required Rio Grande flows at the El Paso Gauge:
* Rio Grande flows at El Paso must exceed 43% of the sum of D2 project deliveries net of Mexican surface diversions.


nm_tx_e(tlater,pp,ww).. X_v('RG_El_Paso_v_f',  tlater,'1-policy_wi_2008_po',ww) =l=
                                                        [D2_v(tlater,'1-policy_wi_2008_po',ww)
                                            -  MX_sw_divert_v(tlater,'1-policy_wi_2008_po',ww)] * 0.43;

***********************************************************************************************************************
* end of 2008 operating agreement code
***********************************************************************************************************************
...
tacres_v.lo   (aguse,nf,k,tlater,'1-policy_wi_2008_po', w) = 1.00 * land_p(aguse,nf,k,tlater);  // lower bound irrigated commercial acreage at historical observed ebid
tacres_v.up   (aguse,nf,k,tlater,'1-policy_wi_2008_po', w) = 1.50 * land_p(aguse,nf,k,tlater);  // upper bound                             1.5 times observed level


*tacres_v.lo   (aguse,nj,k,tlater,'1-policy_wi_2008_po',w) =                1.00 * land_p(aguse,nj,k,tlater);  // sets lower bound of 0.01 for env acres .. these are money losers;
*tacres_v.lo   (aguse,nj,k,tlater,'2-policy_wo_2008_po',w) =    1 +         1.00 * land_p(aguse,nj,k,tlater); // raise lower bound of env crop by 1     .. money losers
tacres_v.lo('EBID_u_f',nj,k,tlater,p,w) =    lb_ecrop + 1.00 * land_p('EBID_u_f',nj,k,tlater);
*tacres_v.lo('EBID_u_f',nj,k,tlater,'2-policy_wo_2008_po',w) =    5 + 1.00 * land_p('EBID_u_f',nj,k,tlater);
...
execute_unload 'swim', evaporation, water_flows, water_stocks, river_flows, total_ag_ben, diversions, SWacres, GWacres, surf_use, r_return_o, urb_price,
...
par=avgstocks              rng =  avgstocks!B2          cdim = 0
par=water_stocks           rng =  avgstocks!D2          cdim = 0
par=avgtotben              rng =  avgtotben!B2          cdim = 0
par=tot_ben                rng =  avgtotben!D2          cdim = 0
par=avgagpumping           rng =  avgagpumping!B2       cdim = 0
par=tot_ag_pump            rng =  avgagpumping!D2       cdim = 0
par=avgenvben              rng =  avgenvben!B2          cdim = 0
par=env_ben                rng =  avgenvben!D2          cdim = 0
par=avginflows             rng =  avginflows!B2         cdim = 0
par=tot_inflows            rng =  avginflows!D2         cdim = 0
par=avgmxflows             rng =  avgmxflows!B2         cdim = 0
par=mx_flows               rng =  avgmxflows!D2         cdim = 0
par=avgrecben              rng =  avgrecben!B2          cdim = 0
par=rec_ben                rng =  avgrecben!D2          cdim = 0
par=avgriverflows          rng =  avgriverflows!B2      cdim = 0
par=river_flows            rng =  avgriverflows!D2      cdim = 0
par=avgswdivertions        rng =  avgswdivertions!B2    cdim = 0
par=diversions             rng =  avgswdivertions!D2    cdim = 0
par=avgswuse               rng =  avgswuse!B2           cdim = 0
par=tot_swuse              rng =  avgswuse!D2           cdim = 0
par=avgtotagben            rng =  avgtotagben!B2        cdim = 0
par=ag_ben                 rng =  avgtotagben!D2        cdim = 0
par=avgtoturbben           rng =  avgtoturbben!B2       cdim = 0
par=tot_urbbenp            rng =  avgtoturbben!D2       cdim = 0
par=avgurbbackuse          rng =  avgurbbackuse!B2      cdim = 0
par=urb_back_use           rng =  avgurbbackuse!D2      cdim = 0
par=avgurbpumping          rng =  avgurbpumping!B2      cdim = 0
par=tot_urbpumping         rng =  avgurbpumping!D2      cdim = 0
par=avgwaterdeliveries     rng =  avgwaterdeliveries!B2   cdim = 0
par=tot_rg_deliveries      rng =  avgwaterdeliveries!D2   cdim = 0
par=avgwaterflows          rng =  avgwaterflows!B2   cdim = 0
par=tot_wat_flows          rng =  avgwaterflows!D2   cdim = 0
par=source_p               rng =  source_p!B2      cdim = 0
